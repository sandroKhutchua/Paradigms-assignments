...
void generateRandomText(map<string, Definition> grammar, string nonTerminal);
...
int main(int argc, char *argv[])
{
  ...
  for(int i = 1; i <= 3; i++) {
    cout << "Version #" << i << ": --------------------------" << endl;
    cout << '\t';
    generateRandomText(grammar, START);
    cout << endl;
    cout << endl;
  }
